...
const char * const G_PLAYBACK              = PRO_NAME_STR".Group.Playback";
...
const char * const G_PLAYBACK_OTHER        = PRO_NAME_STR".Group.Playback.Other";
...
const char * const M_PLAYBACK              = PRO_NAME_STR".Menu.Playback";

...
bool test_1()
{
    ...
    IAggregator *control_curve = IDatabaseObjectFactory::instance()->createObject(Ac::ControlCurveItem);
    CHECK(control_curve);
...
bool test_2()
{
    ...
    const IAggregator *control_curve = IDatabaseObjectFactory::instance()->createObject(Ac::ControlCurveItem);
    CHECK(control_curve);

...
AcScorePrivate::AcScorePrivate(AcScoreObject *q)
    ...
    ,   length(128.0f)
    ,   tracks(new AcTrackList(Score::Tracks))
    ,   timeLines(new AcTimeLineList(Score::TimeLines))
    ,   pitchLines(new AcPitchLineList(Score::PitchLines))
    ,   volumeLines(new AcVolumeLineList(Score::VolumeLines))

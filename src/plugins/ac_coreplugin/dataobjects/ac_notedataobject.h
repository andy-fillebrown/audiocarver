...
#ifndef AC_NOTEDATAOBJECT_H
#define AC_NOTEDATAOBJECT_H

#include "ac_abstractscoredataobject.h"

class AC_CORE_EXPORT NoteDataObject : public AbstractScoreDataObject
{
    friend class CoreDataObjectFactory;

    Q_IAGGREGATOR_DERIVED(NoteDataObject, AbstractScoreDataObject)

...
class IModelItemWatcher : public IAggregate
{
public:
    enum { InterfaceType = I::IModelItemWatcher };

    virtual void parentAboutToBeChanged(const IModelItem *item) = 0;
    virtual void parentChanged(const IModelItem *item) = 0;

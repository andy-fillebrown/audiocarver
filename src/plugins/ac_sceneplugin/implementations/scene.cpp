...
void SceneImpl::drawStaticGL()
{
    d->drawStaticFBO();
}

void SceneImpl::drawModelGL()
{
}

void SceneImpl::drawEditingGL()
{
}

void SceneImpl::drawAnimationGL(qreal time)
{
    d->rotation = 90.0 * time;
    d->drawAnimationFBO();
}

void SceneImpl::drawOverlayGL()
{
}

...
//            int i = 0;
//            for (;  i < bars.count();  ++i)
//                if (bars.at(i)->priority() <= curPriority)
//                    break;
//            QGraphicsTextItem *prevItem = barlineItems.at(i);
//            qreal prevRight = prevItem->pos().x() + (prevItem->boundingRect().width() / 2.0f);
//            ++i;
//            for (;  i < barlineItems.count();  ++i) {
//                QGraphicsTextItem *curItem = barlineItems.at(i);
//                AcBarline *curBar = bars.at(i);
//                if (curBar->priority() <= curPriority) {
//                    qreal curLeft = curItem->pos().x() - (curItem->boundingRect().width() / 2.0f);
//                    if (curLeft - 4 < prevRight) {
//                        --curPriority;
//                        overlaps = true;
//                        break;
//                    } else {
//                        prevItem = curItem;
//                        prevRight = curItem->pos().x() + (curItem->boundingRect().width() / 2.0f);
//                    }
//                }
//            }
//        }

...
#include "aci/instrument-control.aci"
    ...
    ; Calculate signal.
    gaSignal = 0.01 * k_volume * kEnv * aMix
    
    ; Add score event for reverb instrument.
    event_i "i", 3, 0, i_duration + $REVERB_TIME
endin

instr 3
    aReverb reverb gaSignal, $REVERB_TIME
    aOut = gaSignal + (0.05 * aReverb)
    out aOut
    gaSignal = 0
endin

...
//#include <igraphicscurveitem.h>
//#include <imodeldata.h>
//#include <imodelitem.h>
//#include <ivisiblegraphicsitem.h>
...
//            query<IGraphicsCurveItem>(this)->setPoints(velocity_line_points);
//        } break;
//        }
//    }
...
////    {
////        query<IEntity>(this)->highlight(on);
////    }

////    bool isVisible() const
////    {
////        return query<IEntity>(this)->isVisible();
////    }
//};
...
//        IParentEntity *parent_entity = query<IChildEntity>(this)->parent();
//        _graphicsLineItem->setParentItem(query<IGraphicsItem>(parent_entity)->graphicsItem(ControlScene, MainTransform));
...
//                IVisibleGraphicsItem *graphics_item = query<IVisibleGraphicsItem>(sub_entity);
//                if (!graphics_item)
//                    return;

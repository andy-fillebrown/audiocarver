...
/* **** An implementation of Barriers for MAC and Haku that lack them **** */
...
//      csound->Die(csound, "Str(Invalid) NULL Parameter sem");
//    if (*sem != NULL) {
//      int val;
 ...
 */
static int set_element_get(struct set_t *set,
                           char *data,
